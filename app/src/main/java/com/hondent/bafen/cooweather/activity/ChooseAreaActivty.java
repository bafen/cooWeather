package com.hondent.bafen.cooweather.activity;
...
import com.hondent.bafen.cooweather.R;
...
import com.hondent.bafen.cooweather.util.HttpCallbackListener;
import com.hondent.bafen.cooweather.util.HttpUtil;
import com.hondent.bafen.cooweather.util.Utility;
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if("province".equals(type)){
                    ...
                    result = Utility.handleCitisResponse(db,response,selectedProvince.getId());
                }else if("county".equals(type)){
                    result = Utility.handleCountisResponse(db,response,selectedCity.getId());
                }
                if(result){
